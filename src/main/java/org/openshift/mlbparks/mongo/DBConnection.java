...
public class DBConnection {
	...
	public void afterCreate() {
		...
		String mongoUser = (System.getenv("MONGODB_USER")== null) ? "demo" : System.getenv("MONGODB_USER");
		String mongoPassword = (System.getenv("MONGODB_PASSWORD") == null) ? "demo" : System.getenv("MONGODB_PASSWORD");
		String mongoDBName = (System.getenv("MONGODB_DATABASE") == null) ? "demo" : System.getenv("MONGODB_DATABASE");
		...
		if (parkListCollection.count() < 1) {
			...
			try {
				...
				URL jsonFile = new URL(
						"https://raw.githubusercontent.com/piggyvenus/openshift3mlbparks/master/scotia.json");
